...
Register SPEX64RegisterInfo::getStackRegister(const MachineFunction &MF) const {
  ...
  switch (ST.getLane()) {
    case SPEX64Subtarget::Lane0: return SPEX64::R13;
    case SPEX64Subtarget::Lane1: return SPEX64::R29;
    case SPEX64Subtarget::Lane2: return SPEX64::R45;
    case SPEX64Subtarget::Lane3: return SPEX64::R61;
  }
...
BitVector SPEX64RegisterInfo::getReservedRegs(const MachineFunction &MF) const {
  ...
  switch (ST.getLane()) {
    case SPEX64Subtarget::Lane0: Reserved.set(SPEX64::R14); Reserved.set(SPEX64::R15); break;
    case SPEX64Subtarget::Lane1: Reserved.set(SPEX64::R30); Reserved.set(SPEX64::R31); break;
    case SPEX64Subtarget::Lane2: Reserved.set(SPEX64::R46); Reserved.set(SPEX64::R47); break;
    case SPEX64Subtarget::Lane3: Reserved.set(SPEX64::R62); Reserved.set(SPEX64::R63); break;
  }
